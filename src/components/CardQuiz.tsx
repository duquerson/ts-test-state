...
export const CardQuiz: React.FC = () => {
	...
	// Wrapper function para manejar la promesa
	const handleRetry = (): void => {
		void refetch()
	}

	// Wrapper function para reset
	...
	if (isQuizError) {
		const errorMessage = getQuizErrorMessage(quizError as FetchError | null | undefined)
		// ✅ Verificación explícita para string
	...
	// ✅ Verificación explícita para array
