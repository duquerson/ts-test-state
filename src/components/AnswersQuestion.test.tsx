...
vi.mock('../utils/classQuestion', () => ({
	getAnswerButtonClasses: vi.fn((hasBeenAnswered, isCorrectAnswer, isUserAnswer) => {
		if (hasBeenAnswered === false) return 'default-class'
		if (isUserAnswer === true && isCorrectAnswer === true) return 'correct-user-class'
		if (isUserAnswer === true && isCorrectAnswer === false) return 'incorrect-user-class'
		if (isUserAnswer === false && isCorrectAnswer === true) return 'correct-other-class'
